...
app.use(
  cors({
    origin: 'http://localhost:3000', // Replace with the origin of the frontend
...
app.post('/login', async (req, res) => {
  ...
  try {
    ...
    if (user) {
      ...
      console.log('User role attached:', req.user_role);
...
// app.get('/patient-appointments/:id', isAuthenticated, checkUserRole(['patient']), async (req, res) => {
...
app.get('/patient-medical-records/:id', isAuthenticated, checkUserRole(['patient']), async (req, res) => {
  const patientId = req.params.id;
  const xmlFilePath = 'patients.xml';
...
app.get('/patient-medications/:id', isAuthenticated, checkUserRole(['patient']), async (req, res) => {
  const patientId = req.params.id;
  const xmlFilePath = 'patients.xml';
...
app.get('/doctor-patients/:doctorId', isAuthenticated, checkUserRole(['doctor', 'doctor_on_duty']), async (req, res) => {
...
// Endpoint to fetch doctor-specific appointments
app.get('/doctor-appointments/:doctorId', isAuthenticated, checkUserRole(['doctor', 'doctor_on_duty']), async (req, res) => {
  const doctorId = req.params.doctorId;
  const xmlFilePath = 'patients.xml';
...
app.get('/doctor-records/:doctorId', isAuthenticated, checkUserRole(['doctor', 'doctor_on_duty']), async (req, res) => {
  const doctorId = req.params.doctorId;
  const xmlFilePath = 'patients.xml';
...
app.get('/doctor-on-duty-get-patients/:doctorId', isAuthenticated, checkUserRole(['doctor_on_duty']), async (req, res) => {
  const doctorId = req.params.doctorId;
  const xmlFilePath = 'patients.xml';
...
app.get('/nurse-interventions/:nurseId', isAuthenticated, checkUserRole(['nurse', 'nurse_on_duty']), async (req, res) => {
...
app.get('/nurse-on-duty-all-interventions', isAuthenticated, checkUserRole(['nurse_on_duty']), async (req, res) => {
  const xmlFilePath = 'patients.xml';
...
app.get('/doctors', isAuthenticated, checkUserRole(['manager']), async (req, res) => {
  try {
    const client = await pool.connect();
...
// endpoint to fetch users with specific user roles
app.get('/nurses', isAuthenticated, checkUserRole(['manager']), async (req, res) => {
  try {
    const client = await pool.connect();
...
app.get('/doctors-on-duty', isAuthenticated, checkUserRole(['nurse', 'nurse_on_duty']), async (req, res) => {
  try {
    const client = await pool.connect();
